...
CREATE TABLE CARRITO (
    ...
    USUARIO_ID NUMBER UNIQUE NOT NULL, -- Relación uno a uno (o uno a cero) con USUARIOS
    CREADO_EN DATE DEFAULT SYSDATE NOT NULL,
    ACTUALIZADO_EN DATE DEFAULT SYSDATE NOT NULL,
    CONSTRAINT fk_carrito_usuario FOREIGN KEY (USUARIO_ID) REFERENCES USUARIOS(USUARIO_ID)
);

CREATE TABLE ITEM_CARRITO (
    ITEM_CARRITO_ID NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
    CARRITO_ID NUMBER NOT NULL,
    PRODUCTO_ID NUMBER NOT NULL,
    CANTIDAD NUMBER DEFAULT 1 NOT NULL,
    PRECIO_UNITARIO NUMBER(10, 2), -- Precio del producto en el momento de añadirlo
    CREADO_EN DATE DEFAULT SYSDATE NOT NULL,
    ACTUALIZADO_EN DATE DEFAULT SYSDATE NOT NULL,
    CONSTRAINT fk_item_carrito FOREIGN KEY (CARRITO_ID) REFERENCES CARRITO(CARRITO_ID),
    CONSTRAINT fk_item_producto FOREIGN KEY (PRODUCTO_ID) REFERENCES PRODUCTOS(ID_PRODUCTO),
    CONSTRAINT uq_carrito_producto UNIQUE (CARRITO_ID, PRODUCTO_ID) -- Un producto por carrito
);